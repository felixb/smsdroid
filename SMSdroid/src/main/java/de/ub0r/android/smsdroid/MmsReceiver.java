...
public class MmsReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_SMS = "android.provider.Telephony.SMS_DELIVER";
    /** Intent.action for receiving MMS. */
    //private static final String ACTION_MMS = "android.provider.Telephony.WAP_PUSH_RECEIVED";
    private static final String ACTION_MMS = "android.provider.Telephony.WAP_PUSH_DELIVER";
